...
$obj= new Connections(); // Create object of class connection for calling the Personal_Details function
 ...
 if(isset($_POST['username']) && isset($_POST['password']))
	...
	$sql = $obj->db->prepare("select * from college where college_email='$name'");
	$sql->execute();
	...
	echo "<script>window.location='institute/dashboard.php';</script>";
	}
        else
        {
	...
	<div class="container">
		<br><br>
			    <div class="col-md-6 company_ad">
				  <img src="web/images/nankai8-1.jpg" style="width: 100%;">
				</div>
				<div class="col-md-6">
