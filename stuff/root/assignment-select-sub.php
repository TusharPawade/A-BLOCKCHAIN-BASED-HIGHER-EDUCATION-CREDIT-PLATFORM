...
?>
            ...
            <h4>
 <img src="web/images/icon-subject-fd.jpg" style="height:150px; width:150px;">               <br>
<a href="assignment-students.php?branch=<?php echo $_SESSION['branch']; ?>&sem=<?php echo $_SESSION['sem']; ?>&sub=<?php echo $row['ID']; ?>"><?php echo $row['subject']; ?></a></h4>
		<a href="assignment-students.php?branch=<?php echo $_SESSION['branch']; ?>&sem=<?php echo $_SESSION['sem']; ?>&sub=<?php echo $row['ID']; ?>" class="fa-btn btn-1 btn-1e">Enter</a>
			</div>
       <?php } ?>     
