...
<option value="">Select Semister</option>
 ...
 Eighth Semister</option>
  ...
  <div class="form-group">
      <label class="form-label" for="field-2">Notes Title</label>
  ...
  <div class="form-group">
      <label class="form-label" for="field-2">Notes Description</label>
  ...
  <div class="form-group">
      <label class="form-label" for="field-2">Notes File</label>
...
if($obj->Add_Notes($branch,$subject,$sem,$title,$desc,$file)==1)
{	
